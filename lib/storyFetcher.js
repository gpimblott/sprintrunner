...
internals.getStories = function (res, callback, projectID) {
  //Get the list of stories with the label
  var options = {
    url: 'https://www.pivotaltracker.com/services/v5/projects/' + projectID + '/stories?date_format=millis',
    headers: {
      'X-TrackerToken': res.app.get('pivotalApiKey')
    }
  };
 ...
 * @param callback Function to call with the result
 */
storyFetcher.getStoriesWithLabel = function (res, label, projects, callback) {
  var projectArray = [];
