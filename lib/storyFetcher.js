...
storyFetcher.getAllStories = function (res, projects, callback) {
  ...
  var query = pivotalApi.aggregatorHelperAllProjects(projects,
    '/stories?fields=url,current_state,project_id,estimate,name,description,labels(name)&date_format=millis');
...
storyFetcher.getAllStoriesWithStatus = function (res, status, projects, callback) {
  ...
  var query = pivotalApi.aggregatorHelperAllProjects(projects,
    '/stories?date_format=millis&with_state=' + encodeURIComponent(status) + '&fields=url,project_id,current_state,estimate,name,description,labels(name)');
  pivotalApi.aggregateQuery(res, query, function (error, results) {
...
storyFetcher.getAllStoriesWithLabel = function (res, label, projects, callback) {
  ...
  var query = pivotalApi.aggregatorHelperAllProjects( projects,
    '/stories?date_format=millis&with_label=' + encodeURIComponent(label) + '&fields=url,project_id,current_state,estimate,name,description,labels(name)');
  pivotalApi.aggregateQuery(res, query, function (error, results) {
